...
typedef struct
{
    ...
    float p_cmd, v_cmd, t_ff, p_goal, time_cmd, abs_v_cmd; // Desired position, velocity, torque(from CAN Bus)
    float p_des, error_sum, delta_theta;                   // Desired postion in every moment
